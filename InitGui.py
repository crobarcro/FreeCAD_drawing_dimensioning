...
'''
    ...
    def Initialize(self):
        ...
        for module in ['linearDimension', 'deleteDimension', 'circularDimension', 'textAdd', 'textEdit', 'textMove','escapeDimensioning', 'angularDimension' , 'angleFrom3PointsDimension', 'radiusDimension', 'centerLines', 'noteCircle', 'toleranceAdd']:
            if not DEBUG:
                importlib.import_module( module )
            else:
                crudeDebugger.printingDebugging( os.path.join(__dir__, module + '.py') )
                importlib.import_module(  module + '_crudeDebugging')
        commandslist = ['linearDimension', 'circularDimension', 'radiusDimension', 'angularDimension', 'angleFrom3PointsDimension', 'DrawingDimensioning_centerLines', 'DrawingDimensioning_centerLine', 'noteCircle', 'textAddDimensioning','textEditDimensioning', 'textMoveDimensioning', 'toleranceAdd', 'deleteDimension', 'escapeDimensioning']
